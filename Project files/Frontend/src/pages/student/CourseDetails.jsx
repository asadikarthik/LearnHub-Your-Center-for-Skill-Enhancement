    ...
    <>
      ...
      pt-20 text-left'>
        ...
        <div className='max-w-xl z-10 text-gray-500'>
          ...
          <p className='text-sm'>Course by <span className='!text-blue-600 underline'>karthik</span></p>
            ...
            <div className='pt-5'>
              {courseData.courseContent.map((chapter, index) => (
                ...
                rounded'>
                  ...
                  >
                    <ul className='list-disc md:pl-10 pr-4 py-2 text-gray-600 
                        ...
                        <li key={i} className='flex items-start gap-2 py-1'>
                          ...
                          <div className='flex items-center justify-between w-full
                           text-gray-800 text-xs md:text-default'>
                            <p className='text-[15px]'>{lecture.lectureTitle}</p>
                            <div className='flex gap-2'>
                              {lecture.isPreviewFree && (
                                <p  onClick={()=>setPlayerData({
                                  videoId: lecture.lectureUrl.split('/').pop()
                                })} className='text-[15px] !text-blue-500 cursor-pointer'>Preview</p>
                              )}
                              <p className='text-[15px]'>{humanizeDuration(lecture.lectureDuration * 60 * 1000, {
                                  units: ["h", "m"],
                                })}
                              </p>
                            </div>
        ...
        <div className='max-w-[424px] z-10  rounded-t
         ...
         style={{ boxShadow: '0px 4px 15px 2px rgba(0, 0, 0, 0.1)' }}>
          {
            playerData ?
          ...
          <div className='p-5'>
            <div className='flex items-center gap-2'>
              ...
              <span className='font-medium !text-red-500 font-light'>5 days</span> left at this price!</p>
            </div>
