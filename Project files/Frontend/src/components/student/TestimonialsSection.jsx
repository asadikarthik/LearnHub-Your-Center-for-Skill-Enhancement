  ...
  return (
    <div className="pb-14 px-8 md:px-0">
      ...
      <p className="md:text-base text-gray-500 mt-3">
        Hear from our learners as they share their journeys of transformation, success, and how our <br /> platform
        has made a difference in their lives.
      </p>
      <div className='grid gap-8 sm:grid-cols-2 lg:grid-cols-3 mt-14 max-w-4xl'>
        {/* Assuming dummyTestimonial is an array of testimonial objects */}
